defmodule Np do
  ...
  defmodule Releases do
    ...
    @start_apps [:np, :phoenix_ecto, :postgrex, :ecto, :poolboy, :decimal, :db_connection, :connection, :phoenix_live_reload, :file_system,
    ...
    def seed do
      ...
      # Load the code for :np, but don't start it
      :ok = Application.load(:np)

      Logger.info "Starting dependencies.."
      # Start apps necessary for executing migrations
      Enum.each(@start_apps, &Application.ensure_all_started/1)

      # Start the Repo(s) for :np
